...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "publications",
          description: "Selected publications in reverse chronological order, generated by jekyll-scholar.  For a complete list, see Google Scholar (link, bottom of page).",
          section: "Navigation",
          handler: () => {
